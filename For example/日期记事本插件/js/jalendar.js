...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            dayNames['EN'] = new Array('周一1', '周二', '周三', '周四', '周五', '周六', '周日');
            dayNames['TR'] = new Array('周一2', '周二', '周三', '周四', '周五', '周六', '周日');
            dayNames['ES'] = new Array('周一3', '周二', '周三', '周四', '周五', '周六', '周日');
            monthNames['EN'] = new Array('一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'); 
            monthNames['TR'] = new Array('一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'); 
            monthNames['ES'] = new Array('一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'); 
            ...
            // Calculate total event again 计算总时间
