    ...
    FileInput.prototype = {
        ...
        _readFiles: function (files) {
            ...
            var self = this, $el = self.$element, $preview = self.$preview, reader = self.reader,
                ...
                fileTypes = self.allowedFileTypes, fileExt = self.allowedFileExtensions;
				
			fileExt = typeof(fileExt) == 'string'?fileExt.split(','):fileExt;
			fileTypes = typeof(fileTypes) == 'string'?fileTypes.split(','):fileTypes;
			
			var strExt = $h.isEmpty(fileExt) ? '' : fileExt.join(', '),typLen = fileTypes ? fileTypes.length : 0,
