    ...
    var calculateObjectValue = function (self, name, args, defaultValue) {
        ...
        if (typeof name === 'string') {
            ...
            if (names.length > 1) {
                ...
                if(func == undefined) {
                	try {
                		func = $.parseJSON(name.replaceAll("'","\""));
                	}catch(e){
                	}
                }
            }
...
//                    that.onSort(event);
    ...
    BootstrapTable.prototype.onSort = function (event) {
        ...
        if (this.options.sortName === $this.data('field')) {
            ...
            this.options.sortName = $this.data('sortName') || $this.data('field');
    ...
    BootstrapTable.prototype.queryData = function (query) {
        var that = this,
            data = {},
            params = {
        ...
        if (this.options.queryParamsType === 'limit') {
            params = {
                ...
                sortProp: params.sortName,
                sortDirection: params.sortOrder
            };
            if (this.options.pagination) {
            	//修改分页参数，在后台计算分页信息  jiuzhou.hu
            	params.pageNumber = this.options.pageNumber;
...
//        }
    ...
    BootstrapTable.prototype.getCaret = function () {
        ...
        $.each(this.$header.find('th'), function (i, th) {
            $(th).find('.sortable').removeClass('desc asc').addClass(($(th).data('sortName') || $(th).data('field')) === that.options.sortName ? that.options.sortOrder : 'both');
        });
    };
        ...
        $('[data-toggle="table"]').bootstrapTable()
        	.on('check.bs.table uncheck.bs.table check-all.bs.table uncheck-all.bs.table', function () {
	    		...
	    		if(opts && opts.toolbar) {
	    			$(opts.toolbar).find(".btn-linkage").prop('disabled', !$table.bootstrapTable('getSelections').length);
	    		}
	        });
    });
}(jQuery);
